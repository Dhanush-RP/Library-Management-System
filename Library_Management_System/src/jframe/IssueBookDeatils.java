 ...
 * @author Dhanush
 */
public class IssueBookDeatils extends javax.swing.JFrame {

    /**
     * Creates new form IssueBookDetails
     */
    public IssueBookDeatils() 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(565, 40, 270, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IssueBookDeatils.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IssueBookDeatils().setVisible(true);
            }
        });
    }
